...
test_that(deaths$date_occur[which(is.na(deaths$date_occur))], equals(character(0)))
test_that(max(deaths$age), equals(120))
...
test_that(ddply(subset(deaths, intent =="Homicide"), .(year(date_reg)), nrow)$V1, equals(
